...
namespace BridgeBidding
{
    public static class UserText
    {
        ...
        public static string TransferToHearts = "Transfer to hearts";

        public static string TransferToSpades = "Transfer to spades";

        public static string TransferToClubs = "Transfer to clubs";
